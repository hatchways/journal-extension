		...
		<Card className={classes.detailedCard}>
			<CardContent>
				...
				<Box display="flex" justifyContent="space-evenly">
					<Typography variant="body1" color="textSecondary">
						Applied On: {entry.appliedOn.getUTCDay().toString() + "-" + entry.appliedOn.getUTCMonth().toString()}
					</Typography>
					<Typography variant="body1" color="textSecondary">
						FollowUp Date: {entry.followUpDate.getUTCDay().toString() + "-" + entry.followUpDate.getUTCMonth().toString()}
					</Typography>
				</Box>
